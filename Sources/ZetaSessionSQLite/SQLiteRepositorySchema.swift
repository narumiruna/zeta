enum SQLiteRepositorySchema {
    ...
    static let fallbackSearchSchema = """
    ...
    static let searchRebuild = "INSERT INTO entries_fts(entries_fts) VALUES('rebuild');"
}
