...
`scripts/check-release-environment.sh` records actual tool versions and fails unless they match the pinned release toolchain.
...
The release environment gate requires an arm64 host before architecture-specific validation.
