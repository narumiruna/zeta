...
Read [ADR 0001](../adr/0001-dependencies-and-macos-platform.md) before adding a package.
...
Document the required capability and compare the package with plausible platform APIs or focused implementations.
